...
| 交付物 1 | `result` / `deliverable` | 需求主题矩阵 |
| 交付物 2 | `result` / `deliverable` | 证据账本与引用 |
| 交付物 3 | `result` / `deliverable` | 冲突/反例清单 |
| 交付物 4 | `result` / `deliverable` | 假设与验证计划 |
| 交付物 5 | `result` / `deliverable` | 开放问题与候选认知资产 |
