...
| 交付物 1 | `result` / `deliverable` | 结构化PRD |
| 交付物 2 | `result` / `deliverable` | 用户故事与验收标准 |
| 交付物 3 | `result` / `deliverable` | 需求追溯矩阵 |
| 交付物 4 | `result` / `deliverable` | AI系统要求（适用时） |
| 交付物 5 | `result` / `deliverable` | TBD/风险/开放问题 |
