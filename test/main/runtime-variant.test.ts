...
const SOURCE_VARIANT = 'integration';

describe('runtime variant isolation', () => {
  it('locks every direct source entry to this worktree identity', () => {
    expect(RUNTIME_VARIANTS).toEqual(['main', 'cognition', 'expense', 'integration', 'optimization', 'messaging']);
    expect(installRoot.SOURCE_RUNTIME_VARIANTS).toEqual(['cognition', 'expense', 'integration', 'optimization', 'messaging']);
