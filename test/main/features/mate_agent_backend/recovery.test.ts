...
describe('Mate worker recovery', () => {
  it('marks queued/running Mate tasks recoverable without replaying their original prompts', async () => {
    ...
    const recovery = await import('../../../../src/main/features/mate_agent_backend/recovery');
