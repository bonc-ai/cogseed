...
import { getRuntimeOpenAIToolCatalog, getRuntimeToolCatalog } from '../../../../../src/main/features/mate_agent_runtime/kernel/tools/catalog';

describe('Mate Office tool contract', () => {
  it('exposes only Mate host Office tools', () => {
