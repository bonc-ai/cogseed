...
describe('pickBestCliForFallback', () => {
  ...
  it('honors the prefer type when nothing is signed in', async () => {
    vi.mocked(detectAll).mockResolvedValue([
