...
const rendererZh = JSON.parse(readFileSync(
  resolve(__dirname, '../../src/renderer/locales/zh.json'),
  'utf8',
)) as Record<string, string>;

function translateZh(key: string, vars?: Record<string, unknown>) {
  const raw = rendererZh[key] ?? key;
