 ...
 *   mruntime       — Mate Agent runtime backend turns (features/mate_agent_backend)
 ...
 * sid / aid).
 */
const EPHEMERAL_KINDS = ['extract-img', 'reflect', 'memory-extract', 'anon', 'gworker', 'mruntime', 'aside'] as const;
 ...
 *  `extract` + leftover. */
const KNOWN_KINDS_RE = /^(gmember|gworker|gconv|mruntime|memory-extract|extract-img|reflect|skill|agent|anon|aside|cli)(?:-|$)/;
