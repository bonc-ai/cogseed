...
export interface RecallUsageRecord extends RecallJsonRecord { assetId: string; assetVersion: string; taskRunId: string; projectionId?: string; workspaceId?: string; boundary?: 'real'|'degraded'|'test-double'; outcome?: string; createdAt: string; }
export interface RecordRecallUsageInput { assetId: string; assetVersion: string; taskRunId: string; projectionId?: string; workspaceId?: string; boundary?: 'real'|'degraded'|'test-double'; outcome?: string; }
