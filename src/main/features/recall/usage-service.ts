...
export interface RecordRecallUsageInput { assetId: string; assetVersion: string; taskRunId: string; projectionId?: string; workspaceId?: string; messageId?: string; boundary?: 'real'|'degraded'|'test-double'; outcome?: string; }
