...
export function buildP3394OutboundEnvelope(
  ...
  message: string,
  sourceKey: string,
  opts: { scopeKey?: string; parts?: P3394PayloadPart[]; goal?: string; workingDir?: string; executionPrefs?: { reasoningEffort?: 'off' | 'low' | 'high'; model?: string }; references?: P3394OutboundReference[] } = {},
): P3394Envelope {
