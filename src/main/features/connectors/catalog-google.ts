...
export const GOOGLE_ENTRIES: CatalogEntry[] = [
  ...
  // rationale and PC/CLAUDE.md §6.5.
  {
    ...
    transport_template: {
      ...
      args: ['${COGSEED_PC_DIR}/bin/google-workspace-mcp-server.cjs'],
  ...
  },
  {
    ...
    transport_template: {
      kind: 'stdio',
      command: '${COGSEED_NODE}',
      args: ['${COGSEED_PC_DIR}/bin/gmail-mcp-server.cjs'],
      oauth_env_key: 'GOOGLE_ACCESS_TOKEN',
  ...
  },
  {
    ...
    transport_template: {
      kind: 'stdio',
      command: '${COGSEED_NODE}',
      args: ['${COGSEED_PC_DIR}/bin/gcal-mcp-server.cjs'],
      oauth_env_key: 'GOOGLE_ACCESS_TOKEN',
  ...
  },
  {
    ...
    transport_template: {
      kind: 'stdio',
      command: '${COGSEED_NODE}',
      args: ['${COGSEED_PC_DIR}/bin/gdocs-mcp-server.cjs'],
      oauth_env_key: 'GOOGLE_ACCESS_TOKEN',
  ...
  },
  {
    ...
    transport_template: {
      kind: 'stdio',
      command: '${COGSEED_NODE}',
      args: ['${COGSEED_PC_DIR}/bin/gsheets-mcp-server.cjs'],
      oauth_env_key: 'GOOGLE_ACCESS_TOKEN',
  ...
  },
  {
    ...
    transport_template: {
      kind: 'stdio',
      command: '${COGSEED_NODE}',
      args: ['${COGSEED_PC_DIR}/bin/gtasks-mcp-server.cjs'],
      oauth_env_key: 'GOOGLE_ACCESS_TOKEN',
  ...
  },
  {
    ...
    transport_template: {
      kind: 'stdio',
      command: '${COGSEED_NODE}',
      args: ['${COGSEED_PC_DIR}/bin/gsearch-console-mcp-server.cjs'],
      oauth_env_key: 'GOOGLE_ACCESS_TOKEN',
