 ...
 *   `Alex｜21:15:15—21:15:26「好的，晚安。我先试试 Codex…」`，
 ...
 * 理解成了"写摘要"，产出了「会议开始，双方确认能听到对方，张磊提出投屏，Alex 同意。」
 * 「Alex 问本地绑定是否有 cookie…」这类叙述句——信息被压成了结论，第一人称原话口吻全丢。
...
export const REWRITE_SYSTEM_PROMPT = [
  ...
  '【正例（照这个风格写）】',
  '输入：',
  '  U0025｜Alex｜19:32:53｜那我们绑定到本地的这个，它本地是有个 cookie 吗？还是说是就是它怎么就是跟你的这个本地的这个 agent？',
  '  U0026｜Alex｜19:33:02｜他是怎么就你本地的 agent 是怎么健全的呢？',
  '正确输出：',
  ...
  '',
  '【反例（这样做是错的）】',
  '  "会议开始，双方确认能听到对方，张磊提出投屏，Alex 同意。"  ← 第三人称摘要，信息被压成了结论，禁止；',
  '  "Alex 问本地绑定是否有 cookie、本地 agent 如何鉴权；张磊答：……"  ← 复述式，禁止。',
  '',
  '【最容易做错的一条：引例必须原样保留】',
...
export function verifyRewrite(
  ...
  for (const p of paragraphs) {
    ...
    // 例如 "Hello，能听到吗？能听到。那我下来投一下屏吗？好的。" 被署成 Alex——
    // 其中"能听到吗""那我下来投一下屏"是张磊说的，属**归属错误**。
