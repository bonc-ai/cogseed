 ...
 * named agent workers pin that same production budget here so a future
 * schema-default change cannot silently shorten their tool-heavy turns. The
 * commander gets a larger orchestration budget because it
