...
- **External package**: `package-installer` for installing, updating, removing, or listing user-supplied open-source packages; covers the package installer command and dependency-consent flow.
