...
- **External package**: `package-installer` for installing, updating, removing, or listing user-supplied open-source packages; covers the `cogseed-pkg.cjs` CLI and dependency-consent flow.
