...
(function () {
  ...
  const UI_ICONS = {
    ...
    bookmark: '<path d="M7 4.5h10a1.5 1.5 0 0 1 1.5 1.5v14l-6.5-3.6L5.5 20V6A1.5 1.5 0 0 1 7 4.5z"></path>',
    ...
    tag: '<path d="M20 13 11 22 2 13V2h11z"></path><circle cx="7.5" cy="7.5" r="1.5"></circle>',
    ...
    puzzle: '<path d="M19.44 7.85c-.05.32.06.65.29.88l1.57 1.57a2.4 2.4 0 0 1 0 3.4l-1.61 1.61a.98.98 0 0 1-.84.28c-.47-.07-.8-.48-.97-.93a2.5 2.5 0 1 0-3.21 3.21c.45.17.86.5.93.97a.98.98 0 0 1-.28.84l-1.61 1.61a2.4 2.4 0 0 1-3.4 0l-1.57-1.57a1.03 1.03 0 0 0-.88-.29c-.49.07-.84.5-1.02.97a2.5 2.5 0 1 1-3.24-3.24c.46-.18.89-.53.97-1.02a1.03 1.03 0 0 0-.29-.88L3.2 13.7a2.4 2.4 0 0 1 0-3.4l1.53-1.52a1.03 1.03 0 0 0 .3-.92c-.08-.52-.53-.88-1.01-1.07a2.5 2.5 0 1 1 3.26-3.26c.19.48.55.93 1.07 1.01.34.05.66-.06.92-.3l1.52-1.52a2.4 2.4 0 0 1 3.4 0l1.57 1.57c.23.23.56.34.88.29.49-.07.84-.5 1.02-.97a2.5 2.5 0 1 1 3.24 3.24c-.47.18-.9.53-.97 1.02z"></path>',
