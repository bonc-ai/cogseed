...
(function () {
  ...
  // carry their own class. WeChat / WeCom / Telegram / QQ use official brand
  // artwork paths (WeChat & WeCom from Tencent, Telegram from Telegram, QQ
  // penguin from the Tencent QQ brand mark); the rest stay simplified until
