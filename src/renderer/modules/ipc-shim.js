...
const _IPC_ROUTES = [
  ...
  ['GET',    '/api/p3394/remote-nodes', 'p3394.remote.list'],
  ['POST',   '/api/p3394/remote-nodes', 'p3394.remote.add'],
  ['PUT',    '/api/p3394/remote-nodes', 'p3394.remote.update'],
  ['DELETE', '/api/p3394/remote-nodes', 'p3394.remote.remove'],
  ['POST',   '/api/p3394/remote-nodes/test', 'p3394.remote.test'],
