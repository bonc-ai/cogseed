    ...
    if (action === 'review.open') { setView('personal-ontology'); return; }
    {
      ...
      try {
        if (action === 'authorization.begin') {
          ...
          const result = await invoke('touchpoints.test_card_delivery', {});
