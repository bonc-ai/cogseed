...
async function _renderHtmlBody(absPath, displayName, cid, projectId) {
  ...
  _viewerBody.innerHTML = buildFilePreviewHtml('html', _chatMediaLocalUrl(absPath), displayName);
}
...
if (typeof module !== 'undefined' && typeof module.exports === 'object') {
  module.exports = { _kindOf, _extOf, _chatMediaLocalUrl, _viewerAbsPathFromChatMediaLocalUrl, _viewerCanAddToLibrary, _viewerVideoPlaybackOptions, _viewerVideoSeekTarget, buildFilePreviewHtml, isSidePreviewableKind, PREVIEW_HTML_SANDBOX };
}
