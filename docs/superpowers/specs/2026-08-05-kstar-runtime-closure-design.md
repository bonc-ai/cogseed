...
- `src/main/features/evolution/` and `packages/nseap-meta-skill-engine/` for future skill/template evolution.
...
Renderer access must continue through the `window.orkas.invoke` allow-list.
