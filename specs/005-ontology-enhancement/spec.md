...
**Status**: Implemented
**Input**: 用户需求原话：「结合这个（Richard《Personal Ontology v0.1.0》）看一下我们的本体部分」→「三件全做」→「这个前端界面也要全部重构，你也想想」→ 效果图过目「按这个实施」。
