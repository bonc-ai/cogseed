...
function SettingsAbout() {
  ...
  return <><SettingsSection title="CogSeed"><SettingsRow title="桌面应用"><SettingsActions><Button disabled={['checking','downloading'].includes(state)} onClick={() => {setState('checking');timer.current=setTimeout(() => setState('available'),500);}}>{state === 'checking' ? '正在检查…':'检查更新'}</Button><a className="cs-settings-external" href="https://cogseed-open.bonc.com.cn/#view=changelog" target="_blank" rel="noopener noreferrer">版本介绍</a></SettingsActions></SettingsRow></SettingsSection>
